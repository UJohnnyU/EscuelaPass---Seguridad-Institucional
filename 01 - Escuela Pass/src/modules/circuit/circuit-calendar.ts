 ...
 */
export const DEFAULT_CIRCUIT_TIMEZONE = DEFAULT_APP_TIMEZONE;
...
/** Fecha YYYY-MM-DD de un instante en la zona del circuito. */
export function circuitCalendarDate(instant: Date): string {
  return calendarDateInTimeZone(instant, getCircuitTimezone());
}
